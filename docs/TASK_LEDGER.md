...
| P00::central-architecture-adr | READY_FOR_CI | ADR 0001 fixes Central API, SQL Server catalog, server-side Primary/Backup and temporary workstation cache boundaries. |
