...
- [x] Add configuration binding + validation based on `docs/SETTINGS_REFERENCE.md`, including strict rejection of undocumented keys and fail-closed critical invariants.
