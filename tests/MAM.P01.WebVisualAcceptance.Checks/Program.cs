...
try{
 ...
 if(!nav.GetProperty("ok").GetBoolean()||S(nav,"immediate")!="reports"||S(nav,"r")!="reports"||S(nav,"t")!="التقارير"||S(nav,"lang")!="ar"||S(nav,"dir")!="rtl"||S(nav,"writerOwner")!="p131-route-authority-9") throw new Exception($"Arabic navigation failed: {nav.GetRawText()}");
