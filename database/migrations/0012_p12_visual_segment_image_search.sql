...
BEGIN
    ...
    (
        ...
        CONSTRAINT FK_MamVisualSegment_Text FOREIGN KEY (AssetId,SourceKind,SegmentIndex) REFERENCES dbo.MamAssetTextSegment(AssetId,SourceKind,SegmentIndex) ON DELETE CASCADE,
