...
let mobile=document.querySelector('.p128-mobile-menu');
if(!mobile){mobile=document.createElement('button');mobile.type='button';mobile.className='p128-mobile-menu';mobile.setAttribute('aria-label','القائمة');mobile.innerHTML='<i class="bi bi-list"></i>';document.body.appendChild(mobile);mobile.addEventListener('click',()=>shell.classList.toggle('p128-mobile-open'));}
