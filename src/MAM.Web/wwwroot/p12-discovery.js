...
shellPage=function(){
  if(route==='search')return `<div id="p12SearchHost" class="p12-search-route-host">${state('loading','Loading',arabic?'جاري تحميل خيارات البحث…':'Loading search options…')}</div>`;
