...
public sealed class UnavailableDiscoveryService : IDiscoveryService
{
    ...
    public Task<ReferenceSubjectSnapshot> UpdateReferenceSubjectAsync(Guid subjectId, UpdateReferenceSubjectRequest request, string actorId, CancellationToken cancellationToken = default) => Task.FromException<ReferenceSubjectSnapshot>(Unavailable());
    public Task DeleteReferenceSubjectAsync(Guid subjectId, string actorId, CancellationToken cancellationToken = default) => Task.FromException(Unavailable());
    public Task<IReadOnlyList<ReferenceSubjectUsageSnapshot>> ListReferenceSubjectUsageAsync(CancellationToken cancellationToken = default) => Task.FromException<IReadOnlyList<ReferenceSubjectUsageSnapshot>>(Unavailable());
